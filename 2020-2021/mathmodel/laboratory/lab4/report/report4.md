...
Колебания гармонического осциллятора без затуханий и без действий внешней силы $\ddot{x} + 5.2x = 0$ имеют следующий фазовый портрет (рис. -@fig:001) и график решений уравнения (рис. -@fig:002):
