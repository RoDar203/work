...
Отсюда мы найдем два значения $x_1 = \frac{k}{3} = \frac{11,5}{4,5}$ и $x_2 = k = \frac{11,5}{2,5}$.
...
$v_{\tau} = \sqrt{12,25v^2 - v^2} = \sqrt{11,25}v$ $v$ $r\frac{d\theta}{dt} = \sqrt{11,25}v$.
...
В первом случае при запуске получившейся программы получаем следующий график (рис. -@fig:001):
...
Во втором случае при запуске получившейся программы получаем следующий график (рис. -@fig:002):
